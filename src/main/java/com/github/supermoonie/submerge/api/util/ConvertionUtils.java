...
import com.github.supermoonie.submerge.api.subtitle.ass.ASSTime;
import com.github.supermoonie.submerge.api.subtitle.ass.Events;
import com.github.supermoonie.submerge.api.subtitle.ass.V4Style;
...
import com.github.supermoonie.submerge.api.subtitle.config.Font;
...
public class ConvertionUtils {
    ...
    public static V4Style createV4Style(SimpleSubConfig config) {
        ...
        style.setPrimaryColour(new AlphaColor(font.getColor()));
        style.setOutlineColour(new AlphaColor(font.getOutlineColor()));
