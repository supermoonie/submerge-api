package com.github.supermoonie.submerge.api.subtitle.ass;

import com.github.supermoonie.submerge.api.color.AlphaColor;
import com.github.supermoonie.submerge.api.util.ColorUtils;
...
public class V4Style implements Serializable {
     ...
     */
    private AlphaColor primaryColour;
     ...
     * The color format contains the alpha channel, too. (AABBGGRR)
     */
    private AlphaColor secondaryColour = AlphaColor.WHITE; // #FFFFFF (white)
     ...
     * The color format contains the alpha channel, too. (AABBGGRR)
     */
    private AlphaColor outlineColour;
    ...
    public String toString() {
        ...
        sb.append(ColorUtils.alphaColorToHAABBGGRR(this.primaryColour)).append(SEP);
        sb.append(ColorUtils.alphaColorToHAABBGGRR(this.secondaryColour)).append(SEP);
        sb.append(ColorUtils.alphaColorToHAABBGGRR(this.outlineColour)).append(SEP);
        sb.append(ColorUtils.alphaColorToHAABBGGRR(this.backColour)).append(SEP);
    ...
    public AlphaColor getPrimaryColour() {
        return primaryColour;
    }

    public void setPrimaryColour(AlphaColor primaryColour) {
        this.primaryColour = primaryColour;
    }

    public AlphaColor getSecondaryColour() {
        return secondaryColour;
    }

    public void setSecondaryColour(AlphaColor secondaryColour) {
        this.secondaryColour = secondaryColour;
    }

    public AlphaColor getOutlineColour() {
        return outlineColour;
    }

    public void setOutlineColour(AlphaColor outlineColour) {
        this.outlineColour = outlineColour;
    }

    public AlphaColor getBackColour() {
        return backColour;
    }

    public void setBackColour(AlphaColor backColour) {
